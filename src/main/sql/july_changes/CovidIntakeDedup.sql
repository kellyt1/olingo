--Drop view covidintakeDedup;
CREATE OR REPLACE VIEW CovidIntakeDedup as
...
alter view covidintakededup owner to covidsalesforce_dms_user;
grant select on  CovidIntakeDedup  to covidsalesforce_user;