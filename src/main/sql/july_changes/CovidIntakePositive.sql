CREATE OR REPLACE VIEW CovidIntakePositive as
...
grant select on covidintakepositive to covidsalesforce_user;
alter view covidintakepositive owner to covidsalesforce_dms_user;