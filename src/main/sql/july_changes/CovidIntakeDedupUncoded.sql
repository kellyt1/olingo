--drop view covidintakededupuncoded;
CREATE OR REPLACE VIEW CovidIntakeDedupUncoded as
...
and (c.dedup_status = '0' or party.dedup_status = '0')
...
alter view covidintakededupuncoded owner to covidsalesforce_dms_user;
grant select on  CovidIntakeDedupUncoded  to covidsalesforce_user;