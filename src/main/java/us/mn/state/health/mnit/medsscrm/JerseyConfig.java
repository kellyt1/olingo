    package us.mn.state.health.mnit.medsscrm;
...
public class JerseyConfig extends ResourceConfig {
    ...
    public JerseyConfig(MedssODataJPAServiceFactory serviceFactory, EntityManagerFactory emf) {
        ...
        register(new MedssRootLocator(serviceFactory));
    ...
    @Path("/")
    public static class MedssRootLocator extends ODataRootLocator {

        private MedssODataJPAServiceFactory serviceFactory;

        public MedssRootLocator(MedssODataJPAServiceFactory serviceFactory) {
