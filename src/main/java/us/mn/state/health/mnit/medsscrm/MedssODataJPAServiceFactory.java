...
@Component
public class MedssODataJPAServiceFactory extends ODataJPAServiceFactory {

    private static final Logger log = LoggerFactory.getLogger(MedssODataJPAServiceFactory.class);

    public MedssODataJPAServiceFactory() {
